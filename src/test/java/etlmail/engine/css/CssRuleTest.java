...
public class CssRuleTest {
	...
	assertThat(rule.getSpecificity()).isEqualTo(new SelectorSpecificity(0, 0, 1));
    }
	...
	assertThat(rule.getSpecificity()).isEqualTo(new SelectorSpecificity(0, 1, 0));
    }
	...
	assertThat(rule.getSpecificity()).isEqualTo(new SelectorSpecificity(1, 0, 0));
    }
	...
	assertThat(rule.getSpecificity()).isEqualTo(new SelectorSpecificity(1, 2, 1));
    }
}
